document.addEventListener('DOMContentLoaded', function () {
    ...
    const numRooms = 2; // Always 2 rooms for this page
    ...
    const pricePerNight = 1000; // Adjust if needed for other room types
    const total = numRooms * numNights * pricePerNight;
